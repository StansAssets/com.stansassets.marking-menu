namespace StansAssets.MarkingMenu
{
    ...
    class VisualElementMarkingMenuItemActivator : IMarkingMenuItemActivator<IMarkingMenuItem>
    {
        public IMarkingMenuItem CreateItem(MarkingMenuItemModel model, ref ItemCreationContext ctx)
        {
            switch (model.Type)
            {
